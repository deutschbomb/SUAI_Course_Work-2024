...
namespace App
{
    public class Presenter : IPresenter
    {
        ...
        public void OrdersTableLoad() { this.db.Orders.Load(); }

        public void WorksTableLoad() { this.db.Works.Load(); }
        ...
        public List<Order> OrdersTableToList() { return this.db.Orders.Local.ToList(); }

        public List<Work> WorksTableToList() { return this.db.Works.Local.ToList(); }
        ...
        public void OrdersRemove(Order order) { this.db.Orders.Remove(order); }

        public void WorksRemove(Work work) { this.db.Works.Remove(work); }
        ...
        public void OrdersAdd(Order order) { this.db.Orders.Add(order); }

        public void WorksAdd(Work work) { this.db.Works.Add(work); }
        ...
        public Order? OrdersFind(int index) { return this.db.Orders.Find(index); }

        public Work? WorksFind(int index) { return this.db.Works.Find(index); }
        ...
        public void OrdersEntry(Order order) { this.db.Orders.Entry(order).State = EntityState.Modified; }

        public void WorksEntry(Work work) { this.db.Works.Entry(work).State = EntityState.Modified; }
